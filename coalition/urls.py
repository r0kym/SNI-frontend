...
urlpatterns = [
    ...
    path('<str:coalition_id>/remove/alliance/<int:alliance_id>', views.remove_alliance, name='coalition-remove-alliance'),
    path('<str:coalition_id>/remove/corporation/<int:corporation_id>', views.remove_corporation, name='coalition-remove-coproation'),
