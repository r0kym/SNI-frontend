...
from utils import SECRET_KEY, DEBUG, ALLOWED_HOSTS, EMAIL_USE_TLS, EMAIL_HOST, EMAIL_PORT, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, ADMINS
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "SNI/static"),
]
